...
class CityscapesMeta(object):
    ...
    def create_label_colormap():
        ...
        colormap[11] = [255, 0, 0]# = [220, 20, 60]
        colormap[12] = [255, 0, 0]# = [255, 0, 0]
        colormap[13] = [0, 0, 0]# = [0, 0, 142]
        colormap[14] = [0, 0, 0]# = [0, 0, 70]
        colormap[15] = [0, 0, 0]# = [0, 60, 100]
        colormap[16] = [0, 0, 0]# = [0, 80, 100]
        colormap[17] = [0, 0, 0]# = [0, 0, 230]
