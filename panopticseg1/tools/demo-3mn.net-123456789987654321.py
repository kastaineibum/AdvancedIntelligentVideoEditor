...
class CityscapesMeta(object):
    ...
    def create_label_colormap():
        ...
        colormap[0] = [0, 0, 0]# = [128, 64, 128]
        colormap[1] = [0, 0, 0]# = [244, 35, 232]
        colormap[2] = [0, 0, 0]# = [70, 70, 70]
        colormap[3] = [0, 0, 0]# = [102, 102, 156]
        colormap[4] = [0, 0, 0]# = [190, 153, 153]
        colormap[5] = [0, 0, 0]# = [153, 153, 153]
        colormap[6] = [0, 0, 0]# = [250, 170, 30]
        colormap[7] = [0, 0, 0]# = [220, 220, 0]
        colormap[8] = [0, 0, 0]# = [107, 142, 35]
        colormap[9] = [0, 0, 0]# = [152, 251, 152]
        colormap[10] = [0, 0, 0]# = [70, 130, 180]
        colormap[11] = [220, 20, 60]# = [220, 20, 60]
        colormap[12] = [255, 0, 0]# = [255, 0, 0]
        colormap[13] = [0, 0, 142]# = [0, 0, 142]
        colormap[14] = [0, 0, 70]# = [0, 0, 70]
        colormap[15] = [0, 60, 100]# = [0, 60, 100]
        colormap[16] = [0, 80, 100]# = [0, 80, 100]
        colormap[17] = [0, 0, 230]# = [0, 0, 230]
        colormap[18] = [119, 11, 32]# = [119, 11, 32]
        return colormap
...
def main():
    ...
    if os.path.exists(args.input_files):
        if os.path.isfile(args.input_files):
            ...
            list_of_files = sorted(filter(os.path.isfile,glob.glob(os.path.join(args.input_files, '*' + args.extension))))
