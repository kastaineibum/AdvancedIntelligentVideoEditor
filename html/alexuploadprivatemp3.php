...
if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) 
{
  ...
  $restimelength = getmusiclength($finalkey,$resfilename);
  $resfps = "0";

  generatemusicsecpic($finalkey,$resfilename,strtomillisec($restimelength));
  $genrst = generatemusicpic2($finalkey,$resfilename);
