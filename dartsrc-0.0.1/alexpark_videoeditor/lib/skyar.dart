...
class SkyARApp extends StatelessWidget 
{
  @override
...
class SkyAR extends StatefulWidget 
{
  @override
  _SkyARState createState() => _SkyARState();
}

class _SkyARState extends State<SkyAR> 
{
  ...
  async
  {
    ...
    +"|"+"skyar"+"|"+AppLocalizations.of(context)!.skyartask+""+DateTime.now().toString().substring(5,19).replaceAll(" ", "").replaceAll(":","").replaceAll("-", "")+"|"
    +globals.packData.blockpickresult[globals.packData.blockpickergetidx("skyaroriginalvideo")]
    +"*"+globals.packData.blockpickresult[globals.packData.blockpickergetidx("skyarskyvideo")]
          ...
          [
            ...
            (
              ...
              [
                ...
                Text(AppLocalizations.of(context)!.skyardesc,style: TextStyle(fontSize: 10),),
                SizedBox
                (
            ...
            pickblockbutton(AppLocalizations.of(context)!.videowanttochangesky,globals.packData.blockpickergetidx("skyaroriginalvideo")),
            pickblockbutton(AppLocalizations.of(context)!.skychangeto,globals.packData.blockpickergetidx("skyarskyvideo")),
            SizedBox(height: globals.packData.buttongap,),
            Text(AppLocalizations.of(context)!.skyarlayercaution,style: TextStyle(fontSize: 10),),
            SizedBox(height: globals.packData.buttongap,),
