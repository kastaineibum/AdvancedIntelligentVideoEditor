import 'package:alexpark_videoeditor/videooperator.dart';
 ...
 */
  ...
  void startTimer3(BuildContext context) 
  {
    CountdownTimer countDownTimer = new CountdownTimer
    (
      new Duration(milliseconds: 100),
  ...
  Widget build(BuildContext context) 
  {
    ...
    if(globals.packData.initflag==1)
    {
      ...
      globals.packData.listheight = scrsize.height*(0.935-globals.packData.videolinepercent);
    ...
    (
      ...
      (
        ...
        percentages: [0.065,globals.packData.videolinepercent,0.935-globals.packData.videolinepercent],
        separatorSize: 4,
            ...
            child: 
                ...
                (
                  ...
                  [
                    ...
                    //CText(k: UniqueKey(),text: '$_refreshtimes',ts: TextStyle(fontSize: 8,color: globals.packData.color2(colorcase: 12)),),
                  ],
                ), 
