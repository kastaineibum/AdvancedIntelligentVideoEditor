...
class PrivateLibPanelApp extends StatelessWidget 
{
  @override
  Widget build(BuildContext context) 
  {
    return MaterialApp(
      ...
      home: PrivateLibPanel(),
    );
  }
}

class PrivateLibPanel extends StatefulWidget 
{
  @override
  _PrivateLibPanelState createState() => _PrivateLibPanelState();
}

class _PrivateLibPanelState extends State<PrivateLibPanel> 
{
  ...
  async
  {
    try
    {
      ...
      filesdesc.clear();
      String vfs = (await globals.packData.jsonPostback("alexgetvideofiles.php", "")).trim();
      ...
      (
        ...
        [
          ...
          (
            ...
            async
            {
              await globals.packData.jsonPostback("alexremovevideofile.php", removefilename);
  ...
  async
  {
    ...
    if(dlgrst==1)
    {
      ...
      await vlu.insertLayerWithFile(false,globals.packData.taplayeridx,addingfilename,
            ...
            (
              ...
              (
                ...
                (
                  ...
                  {
                    String imagepath = globals.configFile.serveraddr+'alexgetpic.php?key='+globals.packData.encodeDES3CBC(globals.configFile.apikey)
                            +'&file='+libfiles[index];
                    return Container
                    (
